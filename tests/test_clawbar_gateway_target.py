...
from scripts import clawbar_collect, clawbar_gateway, clawbar_target_state
...
def setup_required(
    ...
    """Return Gateway Setup Required answers with optional Tailscale devices."""
    answers = {
...
class CollectionTests(CollectorFixture, unittest.TestCase):
    """Resolve and verify one Gateway Target without publishing Private Content."""
